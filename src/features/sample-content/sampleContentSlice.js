...
export const getInteractionDetailsThunk = createAsyncThunk(
  "sampleContent/getInteractionDetails",
  async ({ interactionId }) => {
...
export const sampleContentSlice = createSlice({
  name: "sampleContent",
  initialState,
  reducers: {
    ...
    setCurrentMediaState: (state, action) => {
  ...
  extraReducers: {
    ...
    [getTeamThunk.fulfilled]: (state, action) => {
      return { ...state, success: true, team: action.payload, loading: false };
    },
    [getTeamThunk.pending]: (state) => {
      return { ...state, success: false, loading: true };
    },
    [getTeamThunk.rejected]: (state) => {
      return { ...state, success: false, loading: false };
    },
...
export const { setCurrentAgentState, setCurrentInteractionState, setCurrentMediaState } = sampleContentSlice.actions;
export default sampleContentSlice.reducer;
